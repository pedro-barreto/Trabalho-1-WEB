...
function imagem3() {
    ...
    document.getElementById('imagem').src = 'img/3.jpg';
...
function imagem4() {
    ...
    document.getElementById('imagem').src = 'img/4.jpg';
...
function imagem5() {
    ...
    document.getElementById('imagem').src = 'img/5.jpg';
...
function imagem6() {
    ...
    document.getElementById('imagem').src = 'img/6.jpg';
